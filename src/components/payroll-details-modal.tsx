            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <InfoRow
                  ...
                  value={
                    employee.OTHER_ALLOWANCE_Monthly_Remuneration
                      ? `₹${employee.OTHER_ALLOWANCE_Monthly_Remuneration}`
                      : 'N/A'
                  }
                />
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <InfoRow
                  ...
                  value={
                    employee.OTHER_ALLOWANCE_Annual_Remuneration
                      ? `₹${employee.OTHER_ALLOWANCE_Annual_Remuneration}`
                      : 'N/A'
                  }
                />
            ...
            <div>
              ...
              <div className="space-y-1">
                <InfoRow
                  ...
                  value={
                    employee.Salary_revision_month
                      ? new Date(employee.Salary_revision_month).toLocaleDateString()
                      : 'N/A'
                  }
                />
                <InfoRow
                  ...
                  value={
                    employee.Arrear_with_effect_from
                      ? new Date(employee.Arrear_with_effect_from).toLocaleDateString()
                      : 'N/A'
                  }
                />
                <InfoRow
                ...
                <InfoRow
                  ...
                  value={
                    employee.advanced_salary_date ? new Date(employee.advanced_salary_date).toLocaleDateString() : 'N/A'
                  }
                />
                <InfoRow
