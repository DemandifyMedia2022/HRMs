    ...
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          was employed with Demandify Media Private Limited as a <b>{capitalizedDesignation}</b> in the{' '}
          <b>{capitalizedDepartment}</b> department.
        </p>
        <br />

        <p>
          {pronounSubject.charAt(0).toUpperCase() + pronounSubject.slice(1)} joined our organization on{' '}
          <b>{joiningDate}</b> and worked with us till <b>{relievingDate}</b>.
        </p>
        <br />

        <p>
          During {pronounPossessive} tenure with us, {pronounSubject} has shown dedication, professionalism, and
          commitment to {pronounPossessive} work. {pronounSubject.charAt(0).toUpperCase() + pronounSubject.slice(1)} has
          been a valuable asset to our team.
        </p>
        <br />
