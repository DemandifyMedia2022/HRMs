     ...
     <div style={{display:'flex'}}> 
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          duties as a <b>{capitalizedDesignation}</b> with Demandify Media Private Limited, effective from{' '}
          <b>{relievingDate}</b>.
        </p>
        <br />
        ...
        <p>
          ...
          <b>{relievingDate}</b>. During this period, {pronounSubject} has displayed dedication, professionalism, and
          commitment to the responsibilities assigned.
        </p>
        <br />
