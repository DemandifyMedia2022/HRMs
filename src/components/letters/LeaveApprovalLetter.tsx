    ...
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          <strong>Duration:</strong> {data.leaveDuration} day(s)<br />
          <strong>Approved By:</strong> {capitalizedApprover}
        </p>
        <br />
        
        <p>
          Please ensure that all pending work is completed or delegated before your leave period. 
          You are requested to hand over your responsibilities to your team members and brief them 
          about any ongoing tasks.
        </p>
        <br />
        
        <p>
          If you need to extend your leave for any reason, please inform us in advance and obtain 
