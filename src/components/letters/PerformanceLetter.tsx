    ...
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          <b>{data.reviewPeriod}</b>. We would like to take this opportunity to recognize your 
          accomplishments and identify areas where further development would benefit both you and the company.
        </p>
        <br />
        ...
        <p>
          We truly appreciate your hard work and contributions to <b>{capitalizedCompany}</b>. We 
          encourage you to continue building on your strengths while addressing the areas for 
          improvement noted in this review.
        </p>
        <br />
        
        <p>
          If you have any questions or would like to discuss your review in detail, please feel free 
          to reach out to me.
        </p>
        <br /><br />
