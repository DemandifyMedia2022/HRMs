  ...
  return (
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          We are pleased to offer you the position of <b>{capitalizedDesignation}</b> at Demandify Media Private
          Limited, subject to the terms and conditions mentioned herein.
        </p>
        <br />

        <p>
          <strong>1. Commencement of Employment:</strong>
        </p>
        <p>
          Your employment with us will commence from <b>{joiningDate}</b>.
        </p>
        <br />

        <p>
          <strong>2. Designation & Location:</strong>
        </p>
        <p>
        ...
        <p>
          <strong>3. Probation Period:</strong>
        </p>
        <p>
          You will be on probation for a period of <b>{data.probation}</b> from the date of joining. During this period,
          your performance will be evaluated, and upon satisfactory performance, your services will be confirmed.
        </p>
        <br />
        ...
        <p>
          Your working hours will be <b>{data.workingHours}</b>, Monday to Friday.
        </p>
        <br />
        ...
        <p>
          Your annual Cost to Company (CTC) will be <b>₹{data.ctc}</b>.
        </p>
        <br />
        ...
        <h3 style={{ textAlign: 'center', fontSize: '15px', fontWeight: 600 }}>Annexure A - Salary Details</h3>
