  ...
  return (
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          We are pleased to welcome you to Demandify Media Private Limited as a{' '}
          <b>{capitalizedDesignation}</b> in the <b>{capitalizedDepartment}</b> department.
        </p>
        <br />
        ...
        <p>
          <strong>Date:</strong> {joiningDate}<br />
          <strong>Time:</strong> {formattedTime}<br />
          <strong>Location:</strong> {capitalizedLocation}<br />
        ...
        <p>
          Please report to the HR department on your first day. Our HR team will guide you through 
          the onboarding process and help you settle in.
        </p>
        <br />
        
        <p>
          We look forward to having you as part of our team and wish you a successful career with us.
        </p>
        <br /><br />
