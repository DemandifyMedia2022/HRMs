  ...
  return (
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          We are pleased to inform you that, effective <b>{effectiveDate}</b>, your salary will be 
          increased from <b>₹{data.currentSalary}</b> to <b>₹{data.newSalary}</b>. This salary adjustment 
          reflects our recognition of your hard work, dedication, and the contributions you have made to{' '}
          <b>{capitalizedCompany}</b>.
        </p>
        <br />
        
        <p>
          Your new salary will be effective from <b>{effectiveDate}</b>, and you will see this reflected 
          in your paycheck on the following pay cycle.
        </p>
        <br />
        
        <p>
          We are confident that you will continue to excel in your role, and we look forward to your 
          ongoing success with <b>{capitalizedCompany}</b>.
        </p>
        <br />
        
        <p>
          Should you have any questions regarding this adjustment, please feel free to reach out to 
          your manager, <b>{capitalizedManager}</b>.
        </p>
        <br /><br />
