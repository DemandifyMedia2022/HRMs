    ...
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          behavior violates company policies, and it has been noted in your employee record as of <b>{warningDate}</b>.
        </p>
        <br />

        <p>
          We expect all employees to adhere to our company's code of conduct and performance standards. Failure to
          correct this behavior will result in further disciplinary actions, including but not limited to{' '}
          <b>{data.consequences}</b>.
        </p>
        <br />

        <p>
          If you have any questions regarding this matter or need clarification on company policies, feel free to reach
