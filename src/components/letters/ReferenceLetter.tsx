    ...
    <div style={{display:'flex'}}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          professionalism, dedication, and excellent skills in their role.
        </p>
        <br />

        <p>
          {capitalizedName} has been an integral part of our team, contributing significantly to our projects. Their
          ability to collaborate, solve problems, and take initiative has been commendable, and they have proven to be a
          valuable asset to our organization.
        </p>
        <br />

        <p>
          I have no doubt that <b>{capitalizedName}</b> will continue to excel in their future endeavors. If you require
          further information, please feel free to contact me at {data.managerEmail} or {data.managerContact}.
        </p>
        <br />
        <br />
