  ...
  return (
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          We are writing to inform you of your transfer to the <b>{capitalizedNewDept}</b> department 
          at <b>{capitalizedNewLocation}</b>, effective from <b>{effectiveDate}</b>. This decision has 
          been made considering your skills and the requirements of the new department.
        </p>
        <br />
        
        <p>
          In your new role, you will continue to report to <b>{capitalizedManager}</b> and be expected 
          to meet the objectives outlined for your new department. Your compensation and benefits will 
          remain unchanged during this transition.
        </p>
        <br />
        
        <p>
          We are confident that your experience and expertise will be a great fit for the{' '}
          <b>{capitalizedNewDept}</b>. Should you have any questions or concerns, please feel free to 
          reach out to us.
        </p>
        <br />
        
        <p>We wish you success in your new role at <b>{capitalizedCompany}</b>.</p>
        <br /><br />
