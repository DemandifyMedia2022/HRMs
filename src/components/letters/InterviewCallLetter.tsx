  ...
  return (
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <p style={{ marginTop: '80px' }}><strong>Date:</strong> {data.interviewDate}</p>
        <br />
        ...
        <p>
          We are pleased to inform you that you have been shortlisted for an interview for the position 
          of <b>{capitalizedPosition}</b> at <b>{data.companyName}</b>. Your interview is scheduled for{' '}
        ...
        <p>
          You are requested to bring a copy of your resume and any other relevant documents. You will 
          be meeting with <b>{capitalizedContact}</b>, who will guide you through the process.
        </p>
        <br />
        
        <p>
          We look forward to meeting you and discussing how your skills and experiences align with our needs.
        </p>
        <br />
