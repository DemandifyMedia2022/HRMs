    ...
    <div style={{ position: 'relative', lineHeight: 1.8, color: '#000', fontSize: '14px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p>
          ...
          <b>{capitalizedNewPosition}</b> at <b>{capitalizedCompany}</b>, effective <b>{effectiveDate}</b>. 
          This promotion is a reflection of your hard work, dedication, and the positive contributions you 
        ...
        <p>
          ...
          We look forward to your continued success at <b>{capitalizedCompany}</b>.
        </p>
        <br />
        
        <p>
          Please feel free to reach out to me or your HR if you have any questions regarding your new role.
        </p>
        <br /><br />
