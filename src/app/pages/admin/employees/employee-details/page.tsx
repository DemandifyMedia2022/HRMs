...
export default function EmployeeDetailsPage() {
  ...
  const [prefixSel, setPrefixSel] = useState('');
  const [genderSel, setGenderSel] = useState('');
  const [bloodSel, setBloodSel] = useState('');
  const [empTypeSel, setEmpTypeSel] = useState('');
  const [empStatusSel, setEmpStatusSel] = useState('');
  const [salaryModeSel, setSalaryModeSel] = useState('');
  const [reimbModeSel, setReimbModeSel] = useState('');
  ...
  function toDateFromISO(value: string | null | undefined): Date | undefined {
  ...
  function DatePickerField({
    ...
    const [date, setDate] = useState<Date | undefined>(() => toDateFromISO(defaultValue));
    return (
      <div className="space-y-1">
        <input type="hidden" name={name} value={toISOFromDate(date)} />
        <DatePicker
          id={id}
          value={date}
          onChange={setDate}
  ...
  async function uploadDocumentsFromForm(form: HTMLFormElement) {
    if (!selected) return;
  ...
  async function saveFromForm(form: HTMLFormElement) {
    if (!selected) return;
    const fd = new FormData(form);
    const data: any = {};
    fd.forEach((v, k) => {
  ...
  function handleSubmitConfirm(e: FormEvent<HTMLFormElement>, target: 'save' | 'documents') {
    e.preventDefault();
  ...
  async function onConfirmSave() {
    if (!pendingForm || !pendingTarget) return;
    const form = pendingForm;
    setConfirmOpen(false);
    if (pendingTarget === 'documents') {
      await uploadDocumentsFromForm(form);
    } else {
  ...
  return (
    <>
      ...
      <div className="min-h-screen  p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-gray-900 flex items-center gap-3">Employee Management</h1>
          ...
          <Card className="shadow-lg border-0">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">Employee Directory</CardTitle>
                ...
                <div className="space-y-4">
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="font-semibold text-gray-900 truncate">{pickDisplayName(u)}</div>
                            ...
                            {selected?.id === u.id && <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0" />}
                          </div>
                        </CardContent>
                      </Card>
                    ))}
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    <div className="text-sm text-gray-600">
                      Page <span className="font-semibold">{pageNum}</span> of{' '}
          ...
          <Card className="shadow-lg border-0">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="flex items-center gap-2 mb-2">Employee Details</CardTitle>
                  <CardDescription>
                    {selected
                      ? `Viewing details for ${pickDisplayName(selected)}`
              ...
              {!selected ? (
                ...
                <Tabs value={tab} onValueChange={setTab} className="w-full">
                  ...
                  <TabsContent value="basic" className="mt-6">
                    <form
                      key={`${selected.id}-basic`}
                      className="grid grid-cols-1 sm:grid-cols-2 gap-3"
                      onSubmit={e => handleSubmitConfirm(e, 'save')}
                    >
                      <fieldset disabled={!isEditing} className="contents">
                        <div className="space-y-1">
                          <Label htmlFor="Prefix">Prefix</Label>
                          <Input id="Prefix" name="Prefix" defaultValue={selected.Prefix || ''} placeholder="Prefix" />
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            id="Full_name"
                            name="Full_name"
                            defaultValue={selected.Full_name || selected.name || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            id="emp_code"
                            name="emp_code"
                            defaultValue={selected.emp_code || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input id="gender" name="gender" defaultValue={selected.gender || ''} placeholder="Gender" />
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            id="blood_group"
                            name="blood_group"
                            defaultValue={selected.blood_group || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input id="email" name="email" defaultValue={selected.email || ''} placeholder="Email" />
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            id="Personal_Email"
                            name="Personal_Email"
                            defaultValue={selected.Personal_Email || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            id="Biometric_id"
                            name="Biometric_id"
                            defaultValue={selected.Biometric_id || ''}
                      ...
                      <fieldset disabled={!isEditing} className="contents">
                        <div className="space-y-1">
                          ...
                          <Input
                            id="father_name"
                            name="father_name"
                            defaultValue={selected.father_name || ''}
                            placeholder="Father name"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="father_dob">Father DOB</Label>
                          <DatePickerField
                            id="father_dob"
                            name="father_dob"
                            defaultValue={selected.father_dob}
                            disabled={!isEditing}
                            placeholder="Select date"
                          />
                        </div>
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="mother_dob">Mother DOB</Label>
                          <DatePickerField
                            id="mother_dob"
                            name="mother_dob"
                            defaultValue={selected.mother_dob}
                            disabled={!isEditing}
                            placeholder="Select date"
                          />
                        </div>

                        <div className="col-span-1 sm:col-span-2 text-sm font-semibold">
                          Marital Status & Children Details
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            id="marital_status"
                            name="marital_status"
                            defaultValue={selected.marital_status || ''}
                            placeholder="Marital status"
                            onChange={e => setFamilyMarital(e.target.value)}
                          />
                        </div>
                          ...
                          <>
                            <div className="space-y-1">
                              ...
                              <Input
                                id="child_name"
                                name="child_name"
                                defaultValue={selected.child_name || ''}
                                placeholder="Child name"
                              />
                            </div>
                            <div className="space-y-1">
                              <Label htmlFor="child_dob">Child DOB</Label>
                              <DatePickerField
                                id="child_dob"
                                name="child_dob"
                                defaultValue={selected.child_dob}
                                disabled={!isEditing}
                                placeholder="Select date"
                              />
                            </div>
                            <div className="space-y-1">
                              <Label htmlFor="child_gender">Child gender</Label>
                              <Input
                                id="child_gender"
                                name="child_gender"
                                defaultValue={selected.child_gender || ''}
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="emergency_contact_name">Dependent name</Label>
                          <Input
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.emergency_relation || ''}
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="insuree_name">Nominee name</Label>
                          <Input
                            id="insuree_name"
                            name="insuree_name"
                            defaultValue={selected.insuree_name || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            id="relationship"
                            name="relationship"
                            defaultValue={selected.relationship || ''}
                            placeholder="Relationship"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_dob">Nominee DOB</Label>
                          <DatePickerField
                            id="insuree_dob"
                            name="insuree_dob"
                            defaultValue={selected.insuree_dob}
                            disabled={!isEditing}
                            placeholder="Select date"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_gender">Nominee gender</Label>
                          <Input
                            id="insuree_gender"
                            name="insuree_gender"
                            defaultValue={selected.insuree_gender || ''}
                            placeholder="Nominee gender"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_code">Nominee code</Label>
                          <Input
                            id="insuree_code"
                            name="insuree_code"
                            defaultValue={selected.insuree_code || ''}
                      ...
                      <fieldset disabled={!isEditing} className="contents">
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.employment_status || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.employment_type || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <DatePickerField
                            id="joining_date"
                            name="joining_date"
                            defaultValue={selected.joining_date}
                            disabled={!isEditing}
                            placeholder="Select date"
                          />
                        </div>
                        <div className="space-y-1">
                          ...
                          <DatePickerField
                            ...
                            defaultValue={selected.retirement_date}
                            disabled={!isEditing}
                            placeholder="Select date"
                          />
                        </div>
                      ...
                      <fieldset disabled={!isEditing} className="contents">
                        <div className="space-y-1">
                          ...
                          <Input
                            id="company_name"
                            name="company_name"
                            defaultValue={selected.company_name || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            id="Business_unit"
                            name="Business_unit"
                            defaultValue={selected.Business_unit || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            id="job_role"
                            name="job_role"
                            defaultValue={selected.job_role || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.reporting_manager || ''}
                        ...
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.Functional_manager || ''}
                  ...
                  <TabsContent value="bank" className="mt-6">
                    <form
                      key={`${selected.id}-bank`}
                      className="grid grid-cols-1 sm:grid-cols-2 gap-3"
                      onSubmit={e => handleSubmitConfirm(e, 'save')}
                    >
                      <fieldset disabled={!isEditing} className="contents">
                        <div className="space-y-1">
                          <Label htmlFor="salary_pay_mode">Salary pay mode</Label>
                          <Input
                            id="salary_pay_mode"
                            name="salary_pay_mode"
                            defaultValue={selected.salary_pay_mode || ''}
                            placeholder="Salary pay mode"
                          />
                        </div>
                        <div className="space-y-1">
                        ...
                        <div className="space-y-1">
                          ...
                          <Input id="branch" name="branch" defaultValue={selected.branch || ''} placeholder="Branch" />
                        </div>
                        <div className="space-y-1">
                          ...
                          <Input
                            id="IFSC_code"
                            name="IFSC_code"
                            defaultValue={selected.IFSC_code || ''}
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="reimbursement_ifsc_code">Reimbursement IFSC code</Label>
                          <Input
                            id="reimbursement_ifsc_code"
                            name="reimbursement_ifsc_code"
                            defaultValue={selected.reimbursement_ifsc_code || ''}
                            placeholder="Reimbursement IFSC code"
                          />
                        </div>
                        <div className="space-y-1">
                      ...
                      <fieldset disabled={!isEditing} className="contents">
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            defaultValue={selected.insurance_company || ''}
                            placeholder="Insurance company"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="assured_sum">Assured sum</Label>
                          <Input
                            id="assured_sum"
                            name="assured_sum"
                            defaultValue={selected.assured_sum || ''}
                            placeholder="Assured sum"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_name">Insuree name</Label>
                          <Input
                            id="insuree_name"
                            name="insuree_name"
                            defaultValue={selected.insuree_name || ''}
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="insuree_dob">Insuree DOB</Label>
                          <Input
                            id="insuree_dob"
                            type="date"
                            name="insuree_dob"
                            defaultValue={toDateInput(selected.insuree_dob)}
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_gender">Insuree gender</Label>
                          <Input
                            id="insuree_gender"
                            name="insuree_gender"
                            defaultValue={selected.insuree_gender || ''}
                            placeholder="Insuree gender"
                          />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="insuree_code">Insuree code</Label>
                          <Input
                            id="insuree_code"
                            name="insuree_code"
                            defaultValue={selected.insuree_code || ''}
                            placeholder="Insuree code"
                          />
                        </div>
                      </fieldset>
                      <div className="sm:col-span-2 flex justify-end gap-2">
                  ...
                  <TabsContent value="documents" className="mt-6">
                    <form
                      key={`${selected.id}-documents`}
                      className="space-y-4"
                      onSubmit={e => handleSubmitConfirm(e, 'documents')}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          {hasDocStr(selected.aadhaar_card) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.aadhaar_card)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
                        ...
                        <div>
                          ...
                          {hasDocStr(selected.pan_card) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.pan_card)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
                        ...
                        <div>
                          ...
                          {hasDocStr(selected.bankpassbook) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.bankpassbook)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
                        ...
                        <div>
                          ...
                          {hasDocStr(selected.relieving_letter) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.relieving_letter)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
                        ...
                        <div>
                          ...
                          {hasDocStr(selected.certifications) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.certifications)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
                        ...
                        <div>
                          ...
                          {hasDocStr(selected.marksheet) ? (
                            <div className="mt-1">
                              <Button asChild variant="outline" size="sm">
                                <a href={docUrl(selected.marksheet)} target="_blank">
                                  View Document
                                </a>
                              </Button>
                            </div>
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Confirm {pendingTarget === 'documents' ? 'upload' : 'save'}</AlertDialogTitle>
            <AlertDialogDescription>
              {pendingTarget === 'documents'
                ? "Are you sure you want to upload these documents to the employee's record?"
                : "Save the changes to this employee's details?"}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={onConfirmSave}>Confirm</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
