...
export default function EmployeeDetailsPage() {
  ...
  }: { name: string; id: string; defaultValue?: string | null; disabled?: boolean; placeholder?: string }) {
        ...
        <Card className="shadow-lg border-0">
          ...
          <CardContent>
            {!selected ? (
              ...
              <form key={`${selected.id}-basic`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                ...
                <div className="space-y-1"><Label htmlFor="dob">DOB</Label><DatePickerField id="dob" name="dob" defaultValue={selected.dob} disabled={!isEditing} placeholder="Select date" /></div>
              ...
              <form key={`${selected.id}-family`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
                ...
                <div className="space-y-1"><Label htmlFor="father_dob">Father DOB</Label><DatePickerField id="father_dob" name="father_dob" defaultValue={selected.father_dob} disabled={!isEditing} placeholder="Select date" /></div>
                ...
                <div className="space-y-1"><Label htmlFor="mother_dob">Mother DOB</Label><DatePickerField id="mother_dob" name="mother_dob" defaultValue={selected.mother_dob} disabled={!isEditing} placeholder="Select date" /></div>
                ...
                {familyMarital.trim().toLowerCase() === "married" && (
                  <>
                    ...
                    <div className="space-y-1"><Label htmlFor="child_dob">Child DOB</Label><DatePickerField id="child_dob" name="child_dob" defaultValue={selected.child_dob} disabled={!isEditing} placeholder="Select date" /></div>
                ...
                <div className="space-y-1"><Label htmlFor="insuree_dob">Nominee DOB</Label><DatePickerField id="insuree_dob" name="insuree_dob" defaultValue={selected.insuree_dob} disabled={!isEditing} placeholder="Select date" /></div>
              ...
              <form key={`${selected.id}-employment`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
                ...
                <div className="space-y-1"><Label htmlFor="joining_date">Joining date</Label><DatePickerField id="joining_date" name="joining_date" defaultValue={selected.joining_date} disabled={!isEditing} placeholder="Select date" /></div>
              ...
              <form key={`${selected.id}-position`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
              ...
              <form key={`${selected.id}-bank`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
              ...
              <form key={`${selected.id}-other`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
                ...
                <div className="space-y-1"><Label htmlFor="passport_expiry_date">Passport expiry date</Label><DatePickerField id="passport_expiry_date" name="passport_expiry_date" defaultValue={selected.passport_expiry_date} disabled={!isEditing} placeholder="Select date" /></div>
                <div className="space-y-1"><Label htmlFor="Personal_Email">Personal Email</Label><Input id="Personal_Email" name="Personal_Email" defaultValue={selected.Personal_Email || ""} placeholder="Personal Email" /></div>
              ...
              <form key={`${selected.id}-insurance`} className="grid grid-cols-1 sm:grid-cols-2 gap-3" onSubmit={(e) => handleSubmitConfirm(e, "save")}>
                <fieldset disabled={!isEditing} className="contents">
              ...
              <form key={`${selected.id}-documents`} className="space-y-4" onSubmit={(e) => handleSubmitConfirm(e, "documents")} encType="multipart/form-data">
