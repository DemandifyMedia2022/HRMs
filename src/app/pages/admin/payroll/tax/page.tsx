        ...
        <Card className="border-slate-200 dark:border-slate-700">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <Button variant="outline" size="sm" asChild className="justify-start gap-2">
                <Link href="/pages/admin/payroll/statutory">
                  <IconShieldCheck className="h-4 w-4" /> Statutory
                </Link>
              </Button>
              <Button variant="outline" size="sm" asChild className="justify-start gap-2">
                <Link href="/pages/admin/payroll/tax-slabs">
                  <IconChartBar className="h-4 w-4" /> Tax Slabs
                </Link>
              </Button>
              <Button variant="outline" size="sm" asChild className="justify-start gap-2">
                <Link href="/pages/admin/payroll/tax-estimator">
                  <IconCalculator className="h-4 w-4" /> Tax Estimator
                </Link>
              </Button>
              <Button variant="outline" size="sm" asChild className="justify-start gap-2">
                <Link href="/pages/admin/payroll/tax/update">
