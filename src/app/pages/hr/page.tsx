          ...
          <Card className="lg:col-span-3">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <Button asChild size="lg" variant="outline"><Link href="/pages/hr/leaves">Manage Leaves</Link></Button>
                <Button asChild size="lg" variant="outline"><Link href="/pages/hr/attendance">Manage Attendance</Link></Button>
                <Button asChild size="lg" variant="outline"><Link href="/pages/hr/employees">Manage Employees</Link></Button>
                <Button asChild size="lg" variant="outline"><Link href="/pages/hr/payroll">Payroll</Link></Button>
              </div>
            </CardContent>
          </Card>
        </div>
