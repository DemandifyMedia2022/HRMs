          ...
          {loading ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                <Button
                  variant="outline"
                  className="px-3 py-1 h-auto disabled:opacity-50"
          ...
          <div className="space-y-4">
            <div className="flex gap-2 flex-wrap text-sm">
              {[
                ...
                <button
                  key={k}
                  onClick={() => setTab(String(k))}
                  className={`px-2 py-1 rounded border ${tab === k ? 'bg-gray-900 text-white' : ''}`}
                >
                  {label}
                </button>
              ))}
            ...
            {tab === 'basic' && (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <Input id="emp_code" name="emp_code" defaultValue={selected.emp_code || ''} placeholder="Emp code" />
                </div>
                <div className="space-y-1">
                  <Label htmlFor="dob">DOB</Label>
                  <Input id="dob" type="date" name="dob" defaultValue={toDateInput(selected.dob)} />
                </div>
                <div className="space-y-1">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    type="date"
                    name="father_dob"
                    defaultValue={toDateInput(selected.father_dob)}
                  />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    type="date"
                    name="mother_dob"
                    defaultValue={toDateInput(selected.mother_dob)}
                  />
                </div>
            ...
            {tab === 'position' && (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <Input id="job_role" name="job_role" defaultValue={selected.job_role || ''} placeholder="Job role" />
                </div>
                <div className="space-y-1">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    defaultValue={toDateInput(selected.passport_expiry_date)}
                  />
                </div>
                <div className="space-y-1">
                  <Label htmlFor="Personal_Email">Personal Email</Label>
