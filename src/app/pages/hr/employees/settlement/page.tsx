...
import { Search, Users, Archive, ChevronLeft, ChevronRight, Building2, Mail, Hash, Briefcase, AlertCircle, UserX } from "lucide-react"
        ...
        <Card className="shadow-lg border-0">
          <CardContent className="pt-6">
            <div className="flex items-end gap-3">
              ...
              <Button onClick={() => { setPage(1); load() }} className="h-12">
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {data.map((u) => (
                    <Card key={u.id} className="hover:shadow-xl hover:-translate-y-1 transition-all duration-200 hover:border-primary">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="date_of_resignation" className="text-sm font-medium">Date of Resignation</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor="expected_last_working_day" className="text-sm font-medium">Expected Last Working Day</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor="date_of_relieving" className="text-sm font-medium">Date of Relieving</Label>
                <Input 
              ...
              <div className="md:col-span-2 space-y-2">
                <Label htmlFor="resignation_reason_employee" className="text-sm font-medium">Resignation Reason (Employee)</Label>
                <Input 
              ...
              <div className="md:col-span-2 space-y-2">
                <Label htmlFor="resignation_reason_approver" className="text-sm font-medium">Resignation Reason (Approver)</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor="employee_other_status" className="text-sm font-medium">Other Status</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor="employee_other_status_remarks" className="text-sm font-medium">Other Status Remarks</Label>
                <Input 
