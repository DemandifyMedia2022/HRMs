...
import { Search, History, UserCheck, ChevronLeft, ChevronRight, Building2, Mail, Hash, Calendar, AlertCircle, RefreshCw } from "lucide-react"
              ...
              <div className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                  {rows.map((r) => {
                    ...
                    return (
                      <Card key={r.id} className="hover:shadow-xl hover:-translate-y-1 transition-all duration-200 hover:border-primary cursor-pointer">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-primary-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="text-lg font-semibold text-gray-900">{selected.full_name || selected.name || "Unnamed"}</div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        <Calendar className="w-4 h-4 text-gray-400" />
                        <span className="text-sm font-medium">{fmt(selected.expected_last_working_day) || "N/A"}</span>
                      </div>
                    </div>
                    <div className="space-y-2 p-3 bg-gray-50 rounded-lg">
