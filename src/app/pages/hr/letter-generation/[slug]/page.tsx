    ...
    <div className="p-4 sm:p-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 p-6">
            <div className="flex items-center justify-between text-white">
              <div>
                ...
                <p className="mt-1 text-white/80 text-xs sm:text-sm">Fill the form to preview the letter. Use <strong>Download PDF</strong> for a reliable export.</p>
              </div>
              <Link href="/pages/hr/letter-generation" className="hidden sm:inline-flex items-center gap-2 text-sm font-medium bg-white/10 hover:bg-white/20 px-3 py-2 rounded-lg transition">
                <span>← Back</span>
              </Link>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Form */}
          <form onSubmit={onSubmit} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 sm:p-5 space-y-4 shadow-sm">
            {cfg.fields.map((f) => (
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <button type="submit" className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium shadow-sm transition">Generate Letter</button>
              <button type="button" onClick={handleDownloadSimple} disabled={!showPreview} className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white text-sm font-medium shadow-sm transition">Download PDF</button>
              <button type="button" onClick={handleDownload} disabled={!showPreview} className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white text-sm font-medium shadow-sm transition">Download HTML Snapshot (beta)</button>
              <button type="button" className="px-4 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-sm font-medium transition" onClick={() => setShowPreview(false)}>Clear Preview</button>
            </div>
          </form>
