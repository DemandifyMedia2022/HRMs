...
function HrAvailableLeavePageInner() {
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-[1.8fr,1fr]">
          <Card className="shadow-md border-0">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">Check Leave Balance</CardTitle>
    ...
    {userName}
          ...
          <Card className="shadow-sm border-0 bg-white/70 backdrop-blur">
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2 text-primary">Approved Leaves</CardTitle>
        ...
        {data && (
          <div className="space-y-6">
            ...
            <Card className="shadow-lg border-0 bg-white/90 backdrop-blur">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">All Leaves</CardTitle>
