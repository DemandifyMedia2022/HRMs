...
export default function ProvidentFundPage() {
  ...
  const onConfirmSave = async () => {
    try {
      ...
      toast({
        title: 'Error',
        description: error.message || 'Failed to save provident fund settings',
        variant: 'destructive'
      });
    } finally {
      setSaving(false);
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <RadioGroup value={formData.hra_calc} onValueChange={val => handleInputChange('hra_calc', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="applicable-yes" className="font-normal">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="No" id="applicable-no" />
                    <Label htmlFor="applicable-no" className="font-normal">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      Employees' PF contribution rate (A) % <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.pf} onValueChange={val => handleInputChange('pf', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="pf-actual" className="font-normal">
                          Actual earning for all employees
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Specify contribution limit at employee level" id="pf-specify" />
                        <Label htmlFor="pf-specify" className="font-normal">
                          Specify contribution limit at employee level
                        </Label>
                      </div>
                    </RadioGroup>
                  </div>
                  ...
                  <div>
                    <Label>
                      Employee's contribution <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label className="mb-3 block">
                      On what basis do you want to calculate PF admin charges? (AC21)
                    </Label>
                    <RadioGroup
                      value={formData.admin_charge_basis}
                      onValueChange={val => handleInputChange('admin_charge_basis', val)}
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="PF wages" id="ac21-pf" />
                        <Label htmlFor="ac21-pf" className="font-normal">
                          PF wages
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Pension wages" id="ac21-pension" />
                        <Label htmlFor="ac21-pension" className="font-normal">
                          Pension wages
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="EDLI wages" id="ac21-edli" />
                        <Label htmlFor="ac21-edli" className="font-normal">
                          EDLI wages
                        </Label>
                      </div>
                    </RadioGroup>
                  ...
                  <div>
                    <Label className="mb-3 block">
                      On what basis of contribution do you want to compute PF admin charges? (AC2)
                    </Label>
                    <RadioGroup value={formData.admin} onValueChange={val => handleInputChange('admin', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="ac2-employee" className="font-normal">
                          Employee contribution
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Employer contribution" id="ac2-employer" />
                        <Label htmlFor="ac2-employer" className="font-normal">
                          Employer contribution
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Higher of employer and employee" id="ac2-higher" />
                        <Label htmlFor="ac2-higher" className="font-normal">
                          Higher of employer and employee
                        </Label>
                      </div>
                    </RadioGroup>
                  </div>
                  ...
                  <div>
                    <Label className="mb-3 block">
                      When generating the PF challan, would you like to include 'Gross Rate' or 'Gross Earnings' in the
                      Gross Wages?
                    </Label>
                    <RadioGroup value={formData.gross} onValueChange={val => handleInputChange('gross', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="gross-rate" className="font-normal">
                          Gross Rate
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Gross earning" id="gross-earning" />
                        <Label htmlFor="gross-earning" className="font-normal">
                          Gross earning
                        </Label>
                      </div>
                    </RadioGroup>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      Employer's pension contribution rate (B) % <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label>
                      Pension wage limit <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.process} onValueChange={val => handleInputChange('process', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="process-actual" className="font-normal">
                          Actual earnings
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Specify contribution limit at employee level" id="process-specify" />
                        <Label htmlFor="process-specify" className="font-normal">
                          Specify contribution limit at employee level
                        </Label>
                      </div>
                    </RadioGroup>
                  ...
                  <div>
                    <Label>
                      Employers contribution limit <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      PF admin charges rate % <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label>
                      Minimum monthly PF admin charges <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      EDLI contribution <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      EDLI admin charges rate % <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>
                      Minimum monthly EDLI admin charges <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="prorate-pf" className="font-normal">
                      Prorate PF as per paid days
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="prorate-limit" className="font-normal">
                      Prorate employee's PF contribution limit on paid days
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="process-arrears" className="font-normal">
                      Process PF on arrears
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="show-zero" className="font-normal">
                      Show employees whose PF for the month is zero on challan
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="provision-admin" className="font-normal">
                      Do you want to provision PF admin charges in Employee CTC?
                    </Label>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.fund} onValueChange={val => handleInputChange('fund', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="vpf-yes" className="font-normal">
                          Yes
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="vpf-no" />
                        <Label htmlFor="vpf-no" className="font-normal">
                          No
                        </Label>
                      </div>
                    </RadioGroup>
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.vpf} onValueChange={val => handleInputChange('vpf', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="vpf-gross" className="font-normal">
                          PF gross
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="PF earning" id="vpf-earning" />
                        <Label htmlFor="vpf-earning" className="font-normal">
                          PF earning
                        </Label>
                      </div>
                    </RadioGroup>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>
                      PF Perquisite Rate <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label>
                      PF Perquisite exemption limit <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
        ...
        <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>This will update PF settings for payroll calculations.</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
