    ...
    <>
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">TDS Deductor Information</h1>
            <p className="text-muted-foreground">Manage deductor and responsible person details</p>
          </div>
        ...
        <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Save TDS deductor information?</AlertDialogTitle>
              <AlertDialogDescription>
                This will update organization and responsible person details.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
