        ...
        <Card>
          <CardHeader className="border-b-2 border-primary">
            <div className="flex items-center justify-between">
              <CardTitle className="text-xl font-bold text-primary">TAX SETTING</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>For how many children education allowance would be admissible ? <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Maximum tuition fees exemption for children going to school (annually) ? <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Maximum amount exemption for children going to hostel (annually) ? <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Maximum net taxable amount to avail tax rebate (Old regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Maximum net taxable amount to avail tax rebate (New regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Tax rebate amount (87 A) (Old regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Tax rebate amount (87 A) (New regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Standard deduction (Old regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Standard deduction (New regime) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Super annuation exemption limit <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>Maximum number of propose investment declaration requests in an year <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Maximum number of confirm investment declaration requests in an year <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>From which month should pay by default reimbursements be processed as per bills submitted</Label>
                    <Input
                      type="text"
                      value={formData.month}
                      onChange={(e) => handleInputChange('month', e.target.value)}
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.hra_calc} onValueChange={(val) => handleInputChange('hra_calc', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="hra1" className="font-normal">Prorate with DOJ, projected DOL</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Actual rent paid amount" id="hra2" />
                        <Label htmlFor="hra2" className="font-normal">Actual rent paid amount</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label>Annual rent paid limit to ensure PAN availability of landlord <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Loss from house property exemption limit <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Interest paid on housing loan exemption limit <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <Label>Education cess charge (%) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="mb-2 block">Do you want to deduct TDS in higher slab (if PAN not available)?</Label>
                    <RadioGroup value={formData.tdspan} onValueChange={(val) => handleInputChange('tdspan', val)}>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Yes" id="tdspan-yes" />
                        <Label htmlFor="tdspan-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="tdspan-no" />
                        <Label htmlFor="tdspan-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label className="mb-2 block">Do you want to deduct TDS in higher slab (if Aadhaar is not available)?</Label>
                    <RadioGroup value={formData.tdsadhar} onValueChange={(val) => handleInputChange('tdsadhar', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="tdsadhar-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="tdsadhar-no" />
                        <Label htmlFor="tdsadhar-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label className="mb-2 block">Do you want to deduct TDS in higher slab (if Aadhar is not linked with PAN)?</Label>
                    <RadioGroup value={formData.adhar} onValueChange={(val) => handleInputChange('adhar', val)}>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Yes" id="adhar-yes" />
                        <Label htmlFor="adhar-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="adhar-no" />
                        <Label htmlFor="adhar-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label className="mb-2 block">Do you want to deposit income tax of employees whose salary is withheld?</Label>
                    <RadioGroup value={formData.tds} onValueChange={(val) => handleInputChange('tds', val)}>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Yes" id="tds-yes" />
                        <Label htmlFor="tds-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="tds-no" />
                        <Label htmlFor="tds-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.income} onValueChange={(val) => handleInputChange('income', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="income-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="income-no" />
                        <Label htmlFor="income-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label>Senior citizen age for income tax <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Super senior citizen age for income tax <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Current LTA block period (start year) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label>Current LTA block period (end year) <span className="text-red-500">*</span></Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="mb-2 block">Do you want to add the tax deducted on perquisites with tax challan?</Label>
                    <RadioGroup value={formData.challantax} onValueChange={(val) => handleInputChange('challantax', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="challantax-yes" className="font-normal">Yes</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="No" id="challantax-no" />
                        <Label htmlFor="challantax-no" className="font-normal">No</Label>
                      </div>
                    </RadioGroup>
                  </div>
                  ...
                  <div>
                    ...
                    <RadioGroup value={formData.taxable} onValueChange={(val) => handleInputChange('taxable', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="taxable-5" className="font-normal">5 rupees</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="10 rupees" id="taxable-10" />
                        <Label htmlFor="taxable-10" className="font-normal">10 rupees</Label>
                      </div>
                    </RadioGroup>
                  </div>

                  <div>
                    <Label className="mb-2 block">In case the pay component is taxed on a proportionate basis, then how do you want to treat tax on the arrear part of these components?</Label>
                    <RadioGroup value={formData.component} onValueChange={(val) => handleInputChange('component', val)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="component-prop" className="font-normal">Proportionate</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Pay month" id="component-pay" />
                        <Label htmlFor="component-pay" className="font-normal">Pay month</Label>
                      </div>
                    </RadioGroup>
                  </div>
                </div>
