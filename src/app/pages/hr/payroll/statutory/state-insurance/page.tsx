...
export default function EmployeeStateInsurancePage() {
  ...
  const onConfirmSave = async () => {
    try {
      ...
      toast({ title: "Error", description: error.message || "Failed to save employee insurance settings", variant: "destructive" })
    } finally {
      setSaving(false)
    }
  }
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will update ESI settings for payroll calculations.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
