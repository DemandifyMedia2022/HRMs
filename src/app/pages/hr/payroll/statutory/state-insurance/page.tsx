...
export default function EmployeeStateInsurancePage() {
  ...
  const onConfirmSave = async () => {
    try {
      ...
      const json = await res.json();
      if (json.success) {
        toast({ title: 'Saved', description: 'Employee insurance settings saved successfully' });
    ...
    <>
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold">Employee State Insurance</h1>
            <p className="text-muted-foreground">Configure ESI applicability and contributions</p>
          </div>
        ...
        <Card>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <RadioGroup value={formData.esi} onValueChange={val => handleInputChange('esi', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="esi-yes" className="font-normal">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="No" id="esi-no" />
                    <Label htmlFor="esi-no" className="font-normal">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                <Label>
                  Wage ceiling of ESI contribution <span className="text-red-500">*</span>
                </Label>
                <Input
                  type="number"
                  value={formData.wage}
              ...
              <div>
                ...
                <RadioGroup value={formData.esi_limit} onValueChange={val => handleInputChange('esi_limit', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="esi-limit-yes" className="font-normal">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="No" id="esi-limit-no" />
                    <Label htmlFor="esi-limit-no" className="font-normal">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup value={formData.employer_esi} onValueChange={val => handleInputChange('employer_esi', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="employer-none" className="font-normal">
                      None
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="Nearest" id="employer-nearest" />
                    <Label htmlFor="employer-nearest" className="font-normal">
                      Nearest
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="Higher" id="employer-higher" />
                    <Label htmlFor="employer-higher" className="font-normal">
                      Higher
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup value={formData.employee_esi} onValueChange={val => handleInputChange('employee_esi', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="employee-none" className="font-normal">
                      None
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="Nearest" id="employee-nearest" />
                    <Label htmlFor="employee-nearest" className="font-normal">
                      Nearest
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="Higher" id="employee-higher" />
                    <Label htmlFor="employee-higher" className="font-normal">
                      Higher
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup value={formData.negative} onValueChange={val => handleInputChange('negative', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="negative-yes" className="font-normal">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="No" id="negative-no" />
                    <Label htmlFor="negative-no" className="font-normal">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup value={formData.physical} onValueChange={val => handleInputChange('physical', val)}>
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="physical-yes" className="font-normal">
                      Yes
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="No" id="physical-no" />
                    <Label htmlFor="physical-no" className="font-normal">
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="process-overtime" className="font-normal">
                      Process ESI on overtime
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="process-arrear" className="font-normal">
                      Process ESI on arrear
                    </Label>
                  </div>
                </div>
              </div>
        ...
        <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Save Employee State Insurance settings?</AlertDialogTitle>
              <AlertDialogDescription>This will update ESI settings for payroll calculations.</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
