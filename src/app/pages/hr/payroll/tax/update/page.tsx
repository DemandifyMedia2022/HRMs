            ...
            <CardContent className="space-y-8">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="gross_input" className="font-semibold">
                      Total Gross Salary
                    </Label>
                    <Input
                      type="number"
                    ...
                    <p className="text-xs text-muted-foreground">
                      Enter annual gross amount. Calculations update instantly.
                    </p>
                  </div>
                    ...
                    <CardContent className="grid gap-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={e => {
                            setExemptedAllowances(e.target.value);
                            calculate(grossInput);
                          }}
                          step="0.01"
                        />
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          value={professionTax}
                          onChange={e => {
                            setProfessionTax(e.target.value);
                            calculate(grossInput);
                          }}
                          step="0.01"
                        />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={selfOccupied}
                            onChange={e => setSelfOccupied(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            id="taxesPaidLocal"
                            type="number"
                            value={taxesPaidLocal}
                            onChange={e => setTaxesPaidLocal(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={e => setInterestPayable(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            id="incomeLossHP"
                            type="number"
                            value={incomeLossHouseProperty}
                            onChange={e => setIncomeLossHouseProperty(e.target.value)}
                            step="0.01"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80CCD}
                            onChange={e => setD80CCD(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80CCD2}
                            onChange={e => setD80CCD2(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80DD}
                            onChange={e => setD80DD(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80DDB}
                            onChange={e => setD80DDB(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80E}
                            onChange={e => setD80E(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80EE}
                            onChange={e => setD80EE(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80EEA}
                            onChange={e => setD80EEA(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80EEB}
                            onChange={e => setD80EEB(e.target.value)}
                            step="0.01"
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            type="number"
                            value={d80U}
                            onChange={e => setD80U(e.target.value)}
                            step="0.01"
                          />
                        </div>
                      </div>
                    ...
                    <CardContent className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {Number(calc.totalTaxOld) <= Number(calc.totalTaxNew) ? 'Old' : 'New'}
                        </p>
                      </div>
                      <div>
