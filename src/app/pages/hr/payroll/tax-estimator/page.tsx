                ...
                <UCardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="rounded-md border p-3">
                      ...
                      <div className="text-lg font-semibold">₹{Number.parseFloat(selectedEmployee.Total_Tax || '0').toLocaleString('en-IN')}</div>
                    </div>
                    <div className="rounded-md border p-3">
                      <div className="text-xs text-muted-foreground">New Regime Tax</div>
                      <div className="text-lg font-semibold">₹{Number.parseFloat(selectedEmployee.Total_Tax1 || '0').toLocaleString('en-IN')}</div>
                    </div>
                    <div className="rounded-md border p-3">
                      <div className="text-xs text-muted-foreground">Difference</div>
                      <div className="text-lg font-semibold">₹{(Math.abs((Number(selectedEmployee.Total_Tax1)||0) - (Number(selectedEmployee.Total_Tax)||0))).toLocaleString('en-IN')}</div>
                    </div>
                  </div>
