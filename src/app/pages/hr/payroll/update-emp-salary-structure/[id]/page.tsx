...
export default function EmployeeSalaryStructurePage() {
  ...
  useEffect(() => {
    ...
    formData.CTC,
    formData.Paygroup,
    formData.Employee_PF_Contribution_limit,
    formData.esic,
    formData.Advanced_salary,
    formData.months,
    formData.advanced_salary_date,
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="flex gap-4 mt-2 text-sm text-muted-foreground">
                          ...
                          <span>
                            <strong>Designation:</strong> {employee.job_role || 'N/A'}
                          </span>
                          <span>
                            <strong>Employee Code:</strong> {employee.emp_code || 'N/A'}
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <Card className="mb-4">
                ...
                <CardContent>
                  <div className="flex gap-4 items-end">
                    ...
                    <div className="flex-1">
                      <Label htmlFor="pf_limit" className="text-xs">
                      ...
                      {(() => {
                        ...
                        return (
                          <DatePicker
                            ...
                            value={
                              formData.Salary_revision_month ? new Date(formData.Salary_revision_month) : undefined
                            }
                      ...
                      {(() => {
                        ...
                        return (
                          <DatePicker
                            ...
                            value={
                              formData.Arrear_with_effect_from ? new Date(formData.Arrear_with_effect_from) : undefined
                            }
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Basic_Monthly_Remuneration}
                            readOnly
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Basic_Annual_Remuneration}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.HRA_Monthly_Remuneration}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.HRA_Annual_Remuneration}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.OTHER_ALLOWANCE_Monthly_Remuneration}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.OTHER_ALLOWANCE_Annual_Remuneration}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
              ...
              <Card className="mb-4">
                ...
                <CardContent>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.PF_Monthly_Contribution}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.PF_Annual_Contribution}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                  ...
                  <div className="mt-4 p-3 bg-orange-50 border-l-4 border-orange-400 text-sm">
                    ...
                    respective fund accounts or you will be entitled for them on retirement/separation from
                    organisation.
                  </div>
                </CardContent>
              </Card>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Employee_Esic_Monthly}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Employee_Esic_Annual}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Employer_Esic_Monthly}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
                        <td className="border p-2">
                          <Input
                            type="number"
                            value={formData.Employer_Esic_Annual}
                            readOnly
                            className="border-none bg-transparent"
                          />
                        </td>
