...
export default function EmployeeSalaryPage() {
  ...
  return (
    <>
                              ...
                              <TableRow key={employee.id}>
                                ...
                                <TableCell className="text-right">
                                  <div className="flex gap-2 justify-end">
                                    <Button size="sm" variant="outline" onClick={() => handleViewClick(employee)}>
      ...
      <PayrollDetailsModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} employee={selectedEmployee} />
    </>
  );
}
